...
# Description:
#       Data wrangling for Columbia black-tailed deer in the Indigo WMU in 2015
...
# Path to Excel file
path <- "./Data/0_Raw/2015IndigoHuman2015_forODFW_17Feb25.xlsx"
...
assn_path <- "./Data/0_Raw/2015 Deer Matching.xlsx"
...
data_geo <- as.data.frame(df_list$`Indigo Human sample info`)
data_gen <- as.data.frame(df_list$`All InH genotype data`)
data_assn <- as.data.frame(assn_df_list$`2015 Indigo human-collected`)
...
saveRDS(data_merge, file = "./Data/1_YearWMU_processed/rds/2015IndigoHuman.rds")
