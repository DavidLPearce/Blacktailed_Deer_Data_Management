...
# Description:
#       Data wrangling for Columbian black-tailed deer in the Applegate WMU in 2018
...
# Path to Excel file
path <- "./Data/0_Raw/2018 Applegate Dog.xlsx"
...
data_gen <- df_list$`All 2018 ApD Genotypes`
data_assn <- df_list$`2018 ApD Deer Assignment`
...
saveRDS(data_merge, file = "./Data/1_YearWMU_processed/2018ApplegateDog.rds")
