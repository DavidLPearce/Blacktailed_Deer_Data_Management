...
# Description:
#       Data wrangling for Columbian black-tailed deer in the Tioga WMU in 2018
...
# Path to Excel file
path <- "./Data/0_Raw/2018 Tioga Human.xlsx"
...
saveRDS(data_merge, file = "./Data/1_YearWMU_processed/2018TiogaHuman.rds")
