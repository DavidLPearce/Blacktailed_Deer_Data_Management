...
# Path to Excel file
path <- "./Data/0_Raw/2014TraskDog2014_forODFW_10July15.xlsx"
...
data_geo <- as.data.frame(df_list$`Trask Dog sample info`)
data_gen <- as.data.frame(df_list$`2014 TrD Genotype Data`)
data_assn <- as.data.frame(assn_df_list$`2014 Trask Dog-collected`)
...
saveRDS(data_merge, file = "./Data/1_YearWMU_processed/rds/2014TraskDog.rds")
