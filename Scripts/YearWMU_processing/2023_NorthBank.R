...
# Path to Excel file
path <- "./Data/0_Raw/2023-North_Bank_BTD_21July25.xlsx"
...
data_merge <- data_merge %>% 
  rename(
    ...
    # Notes
    "Collection_Notes" = "Sample Comments (collection)",
    "OSU_Notes" = "OSU Notes",
    "Extraction_Notes" = "Extraction notes",
    "Processing_Notes" = "Processing Notes (OSU)",
    # "Marker_Notes" = , 
    # "Location_Notes" = ,
    # "Other_Notes" = ,
...
saveRDS(cbtd_data, file = "./Data/1_YearWMU_processed/2023NorthBank.rds")
