...
# Path to Excel file
path <- "./Data/0_Raw/2016TiogaHuman2016.xlsx"
...
data_geo <- df_list$`Tioga Human sample info`
data_gen <- df_list$`All 2016 Tioga Human Genotypes`
data_assn <- df_list$`2016 TiH Deer Assignment`
...
data_geo$`OSU label` <- paste0("TiH0", 
                                sub("TiH", "", data_geo$`OSU label`))
...
saveRDS(data_merge, file = "./Data/1_YearWMU_processed/2016TiogaHuman.rds")
