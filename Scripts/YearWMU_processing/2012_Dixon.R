...
# Path to Excel file
path <- "./Data/0_Raw/2012 Dixon genos_25June19.xlsx"
...
data_gen <- as.data.frame(df_list$`2012 Dixon genos-ALL`)
data_assn <- as.data.frame(assn_df_list$`2012 Dixon`)
...
saveRDS(data_merge, file = "./Data/1_YearWMU_processed/rds/2012Dixon.rds")
