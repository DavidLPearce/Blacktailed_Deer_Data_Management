...
# Description:
#       Data wrangling for Columbian black-tailed deer in the Saddle Mountain WMU in 2021
#              
#              
#              
#                           
...
# Path to Excel file
path <- "./Data/0_Raw/2021_Saddle_Mountain_Dog.xlsx"
...
data_gen <- df_list$`All 2021 SMD Genotypes` 
...
saveRDS(data_merge, file = "./Data/1_YearWMU_processed/2021SaddleMountain.rds")
