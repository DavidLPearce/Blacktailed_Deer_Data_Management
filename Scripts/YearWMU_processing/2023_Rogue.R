...
# Description:
#       Data wrangling for Columbian black-tailed deer in the Rogue WMU in 2023
#              
#              
#              
#                           
...
# Path to Excel file
path <- "./Data/0_Raw/2023-Rogue_Dog_17June24.xlsx"
...
saveRDS(data_merge, file = "./Data/1_YearWMU_processed/2023Rogue.rds")
