...
# Description:
#       Data wrangling for Columbian black-tailed deer in the Tioga WMU in 2017
...
# Path to Excel file
path <- "./Data/0_Raw/2017Tioga Dog.xlsx"
...
saveRDS(data_merge, file = "./Data/1_YearWMU_processed/2017TiogaDog.rds")
