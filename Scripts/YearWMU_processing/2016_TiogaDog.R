...
# Path to Excel file
path <- "./Data/0_Raw/2016TiogaDog2016.xlsx"
...
data_gen <- df_list$`All 2016 Tioga Dog Genotypes`
data_assn <- df_list$`2016 TiD Deer Assignment`
...
# Assignment data is missing a 0 in OSU ID name
# prevents matching in Lat/Long
data_assn$`OSU label` <- paste0("TiD0", 
                                sub("TiD", "", data_assn$`OSU ID`))
...
saveRDS(data_merge_13loci, file = "./Data/1_YearWMU_processed/rds/2016TiogaDog_13loci.rds")
