...
# Path to Excel file
path <- "./Data/Raw/2019_Applegate_Human.xlsx"
...
data_gen <- df_list$`All 2019 ApH Genotypes` 
data_assn <- df_list$`2019 ApH Deer Assignment`
...
saveRDS(data_merge, file = "./Data/Cleaned/rds/2019ApplegateHuman.rds")
