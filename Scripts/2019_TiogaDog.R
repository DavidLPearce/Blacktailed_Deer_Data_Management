...
# Path to Excel file
path <- "./Data/Raw/2019_Tioga_Dog.xlsx"
...
data_gen <- df_list$`All 2019 Tioga Dog Genotypes` 
data_assn <- df_list$`2019 TiD Deer Assignment`
...
saveRDS(data_merge, file = "./Data/Cleaned/rds/2019TiogaDog.rds")
